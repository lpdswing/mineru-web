...
MinerU Web 是一个面向文档解析和结果核验的 Web 应用，提供文件上传、异步解析、原文件预览、Markdown 预览、PDF 溯源阅读、Popo 增强结果对照和 Markdown 导出能力。当前版本适配 MinerU 3.3.1，业务后端通过官方 MinerU HTTP 服务解析文件，不再直接依赖 MinerU 内部 Python API。
